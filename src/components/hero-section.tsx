      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-3 space-y-6 order-2 lg:order-1">
            <div
              className="ghibli-glass p-4 rounded-xl border border-white/15 bg-[#0E0E12] flex flex-col items-center text-center group cursor-pointer hover:border-white/40 transition-all duration-300"
            ...
            <div className="ghibli-glass p-5 rounded-xl border border-white/15 bg-[#0E0E12] space-y-3 font-mono text-xs">
          ...
          <div className="lg:col-span-6 flex flex-col items-center text-center order-1 lg:order-2">
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full border border-white/20 bg-bg-surface text-[11px] font-mono text-white mb-4">
            ...
            <div className="flex flex-wrap justify-center items-center gap-3 text-text-secondary mb-6">
              <a
                ...
                className="p-3 rounded-xl border border-white/20 bg-bg-surface text-white hover:bg-white hover:text-black transition-all duration-300"
                aria-label="GitHub"
              >
              ...
              <div className="flex items-center gap-2 px-4 py-2.5 rounded-xl border border-white/15 bg-bg-surface text-xs font-mono text-text-secondary">
          ...
          <div className="lg:col-span-3 space-y-6 order-3">
            <div className="ghibli-glass p-3 rounded-xl border border-white/15 bg-[#0E0E12] space-y-3 group hover:border-white/40 transition-all duration-300">
